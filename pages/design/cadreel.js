...
export default function cadreel() {
  return (
    <Container>
      <div className="page relative" tabIndex="0">
        <h1 className="project-heading h1-styled">Cad Showreel</h1>

        <h2 className="h2-styled">Smartwatch Concept</h2>
        <img
          ...
          srcSet="https://res.cloudinary.com/carlhernek/image/upload/f_auto,q_70,w_256/v1582198505/Website/ImgCAD/7_qepbsd.png 256w,
        ...
        <img
          ...
          srcSet="https://res.cloudinary.com/carlhernek/image/upload/f_auto,q_70,w_256/v1582198505/Website/ImgCAD/4_st4z6k.png 256w,
        ...
        <img
          ...
          srcSet="https://res.cloudinary.com/carlhernek/image/upload/f_auto,q_70,w_256/v1582198505/Website/ImgCAD/6_gavjok.png 256w,
        ...
        <ul>
          <li>Design study of design trends in Q4 2018.</li>
          <li>Modeled in SolidWorks.</li>
          <li>Render in Keyshot.</li>
        </ul>

        <h2 className="h2-styled">Logi Remote</h2>
        <img
          className="project-banner"
        ...
        <ul>
          <li>Wireless speaker remote inspired by Logi keyboard with dial.</li>
          <li>Modeled in SolidWorks.</li>
          <li>Render in Keyshot.</li>
        </ul>

        <h2 className="h2-styled">PC Case</h2>
        <img
          className="project-banner"
          ...
          srcSet="https://res.cloudinary.com/carlhernek/image/upload/f_auto,q_70,w_256/v1582198505/Website/ImgC/AD/Render_1_uenb3n.jpg 256w,
        ...
        <ul>
          <li>Desktop PC Case - Compact and minimalistic design.</li>
          <li>Modeled in SolidWorks.</li>
          <li>Render in Keyshot.</li>
        </ul>

        <h2 className="h2-styled">Casio F-91W</h2>
        <img
          className="project-banner"
          alt="Logitech inspired wireless remote"
          src="https://res.cloudinary.com/carlhernek/image/upload/f_auto,q_auto,w_512/v1582198505/Website/img/CAD/Casio.46_ag5dt3.png"
          srcSet="https://res.cloudinary.com/carlhernek/image/upload/f_auto,q_70,w_256/v1582198505/Website/ImgCAD/Casio.46_ag5dt3.png 256w,
        ...
        <ul>
          <li>Modeling and rendering study of this timeless timepiece.</li>
          <li>Modeled in Rhinoceros.</li>
          <li>Render in Keyshot.</li>
        </ul>
